...
function love.update(dt)
    ...
    elseif gameState == 'play' then
      ...
      -- This part of the code makes it to where player 2's paddle
      -- will always be the same as the ball on the y-axis
      ...
      -- This part of the code makes it to where player 1's paddle
      -- will always be the same as the ball on the y-axis
